(function (w,d,n) {
    ...
    wb.doButton = function () {
        ...
        $('<style type="text/css">@import url("http://wishlu.com/content/bookmarklet.css");</style>').appendTo("head");
    ...
    // util function (TODO: add credit to author)
    ...
    wb.popUp = function (img, name, desc) {
        ...
        wb.w.open('http://wishlu.com/button/share?url=' + encodeURIComponent(window.location.href) + '&image=' + img + '&name=' + name + '&description=' + desc, 'wishlu button - popup', 'status=no,height=' + wh + ",width=" + ww + ",resizable=yes,left=0,top=0,toolbar=no,menubar=no,scrollbars=yes,personalbar=no,location=no,directories=no");
